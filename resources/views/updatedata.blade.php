            ...
            <ul>
                ...
                <li >
                    ...
                    <label for="sex-man" class="radio_label checked">
                        <input type="radio" value="1" {!! $information->sex==1?"checked='checked'":"" !!} id="sex-man" name="sex" />
                        男
                    </label>
                    <label for="sex-female" class="radio_label">
                        <input type="radio" value="2"{!! $information->sex==2?"checked='checked'":"" !!} id="sex-female" name="sex" />
                        女
                    </label>
                </li>
                <li>
